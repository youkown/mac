/*
 * Framework: net.lc4ever.framework.domain.display.DataGrid.java create by q-wang on May 20, 2013 1:23:35 AM
 * VCS Tag: $Id$
 */
 ...
 */
public class DataGrid implements BaseEntity<Long> {
