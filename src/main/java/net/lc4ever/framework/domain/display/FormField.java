/*
 * Framework: net.lc4ever.framework.domain.display.FormField.java create by q-wang on May 20, 2013 1:24:34 AM
 * VCS Tag: $Id$
 */
 ...
 *
 */
public class FormField implements BaseEntity<Long> {
